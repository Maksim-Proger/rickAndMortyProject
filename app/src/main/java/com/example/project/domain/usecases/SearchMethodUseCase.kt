...
class SearchMethodUseCase @Inject constructor(
    private val repositoryApi: RepositoryApi
) {
    operator fun invoke(name: String): Flow<PagingData<DomainModelCharacter>> {
        return repositoryApi.searchMethod(name)
    }
}